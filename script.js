// =====================================================
// YOUNITED - SCRIPT PRINCIPAL v62.0
// =====================================================
...
const emailTexts = {
  ...
  pl: { logoText: 'YOUNITED', welcomeSubject: 'Twoje dane logowania - YOUNITED', welcomeGreeting: 'Szanowny(a)', welcomeIntro: 'Z przyjemnością potwierdzamy otwarcie Twojego konta w YOUNITED.', welcomeThanks: 'Dziękujemy za zaufanie.', welcomeAccess: 'Aby uzyskać dostęp do konta klienta online:', welcomeIdentifier: 'Identyfikator', welcomePin: 'Kod PIN', welcomeButton: 'Wejdź na swoje konto', welcomeSignature: 'Z poważaniem.', activationSubject: 'Kod aktywacyjny zlecenia przelewu - YOUNITED', activationIntro: 'Kod aktywacyjny Twojego zlecenia przelewu to:', receiptSubject: 'Potwierdzenie przelewu - YOUNITED', receiptFailedSubject: 'Przelew nieudany - YOUNITED', receiptCancelSubject: 'Przelew anulowany - YOUNITED', receiptTitle: 'Przelew zrealizowany', receiptFailedTitle: 'Przelew nieudany', receiptCancelTitle: 'Przelew anulowany', receiptAmount: 'KWOTA', receiptBeneficiary: 'Odbiorca', receiptIban: 'IBAN', receiptBank: 'Bank', receiptSwift: 'SWIFT / BIC', receiptDate: 'Data', receiptStatus: 'Status', receiptStatusDone: 'Zrealizowany', receiptStatusFailed: 'Nieudany na {percent}%', receiptStatusCancelled: 'Anulowany', receiptReason: 'Powód', receiptReference: 'Referencja', receiptSuccessIntro: 'Twój przelew został zrealizowany.', receiptFailedIntro: 'Twój przelew nie powiódł się.', receiptCancelledIntro: 'Twój przelew został anulowany.', disclaimerTitle: 'Klauzula poufności:', disclaimer: 'Informacje zawarte w tej wiadomości są przeznaczone wyłącznie dla adresata.',
    pendingTransferEmailSubject: 'Przelew oczekujący - YOUNITED', pendingTransferEmailTitle: 'Przelew oczekujący', pendingTransferEmailIntro: 'Twój przelew oczekuje na zatwierdzenie.', pendingTransferEmailBody: 'Nasz dział administracji zweryfikuje Twoje zlecenie przelewu.', pendingTransferEmailFooter: 'Kwota została pobrana.',
    pendingValidatedSubject: 'Przelew zatwierdzony - YOUNITED', pendingValidatedTitle: 'Przelew zatwierdzony', pendingValidatedIntro: 'Twój przelew został zatwierdzony.', pendingValidatedBody: 'Oficjalne potwierdzenie w formacie PDF jest załączone.',
    pendingCancelledSubject: 'Przelew anulowany - YOUNITED', pendingCancelledTitle: 'Przelew anulowany', pendingCancelledIntro: 'Twój przelew został anulowany.', pendingCancelledBody: 'Kwota została zwrócona na Twoje konto.' },
  es: { logoText: 'YOUNITED', welcomeSubject: 'Sus credenciales - YOUNITED', welcomeGreeting: 'Estimado(a)', welcomeIntro: 'Nos complace confirmarle la apertura de su cuenta.', welcomeThanks: 'Le agradecemos su confianza.', welcomeAccess: 'Para acceder a su área de cliente:', welcomeIdentifier: 'Identificador', welcomePin: 'Código PIN', welcomeButton: 'Acceder a mi cuenta', welcomeSignature: 'Saludos cordiales.', activationSubject: 'Código de activación - YOUNITED', activationIntro: 'El código de activación es:', receiptSubject: 'Confirmación de transferencia - YOUNITED', receiptFailedSubject: 'Transferencia fallida - YOUNITED', receiptCancelSubject: 'Transferencia cancelada - YOUNITED', receiptTitle: 'Transferencia realizada', receiptFailedTitle: 'Transferencia fallida', receiptCancelTitle: 'Transferencia cancelada', receiptAmount: 'IMPORTE', receiptBeneficiary: 'Beneficiario', receiptIban: 'IBAN', receiptBank: 'Banco', receiptSwift: 'SWIFT / BIC', receiptDate: 'Fecha', receiptStatus: 'Estado', receiptStatusDone: 'Completado', receiptStatusFailed: 'Fallido al {percent}%', receiptStatusCancelled: 'Cancelado', receiptReason: 'Motivo', receiptReference: 'Referencia', receiptSuccessIntro: 'Su transferencia se ha realizado con éxito.', receiptFailedIntro: 'Su transferencia falló.', receiptCancelledIntro: 'Su transferencia ha sido cancelada.', disclaimerTitle: 'Confidencialidad:', disclaimer: 'La información contenida en este correo está destinada únicamente al destinatario.',
    ...
    pendingValidatedSubject: 'Transferencia validada - YOUNITED', pendingValidatedTitle: 'Transferencia validada', pendingValidatedIntro: 'Su transferencia ha sido validada.', pendingValidatedBody: 'Su recibo PDF está adjunto.',
  ...
  it: { logoText: 'YOUNITED', welcomeSubject: 'Le tue credenziali - YOUNITED', welcomeGreeting: 'Gentile', welcomeIntro: 'Siamo lieti di confermarle l\'apertura del conto.', welcomeThanks: 'La ringraziamo per la fiducia.', welcomeAccess: 'Per accedere alla sua area clienti:', welcomeIdentifier: 'Identificativo', welcomePin: 'Codice PIN', welcomeButton: 'Accedi al mio conto', welcomeSignature: 'Cordiali saluti.', activationSubject: 'Codice di attivazione - YOUNITED', activationIntro: 'Il codice di attivazione è:', receiptSubject: 'Conferma bonifico - YOUNITED', receiptFailedSubject: 'Bonifico fallito - YOUNITED', receiptCancelSubject: 'Bonifico annullato - YOUNITED', receiptTitle: 'Bonifico eseguito', receiptFailedTitle: 'Bonifico fallito', receiptCancelTitle: 'Bonifico annullato', receiptAmount: 'IMPORTO', receiptBeneficiary: 'Beneficiario', receiptIban: 'IBAN', receiptBank: 'Banca', receiptSwift: 'SWIFT / BIC', receiptDate: 'Data', receiptStatus: 'Stato', receiptStatusDone: 'Eseguito', receiptStatusFailed: 'Fallito al {percent}%', receiptStatusCancelled: 'Annullato', receiptReason: 'Motivo', receiptReference: 'Riferimento', receiptSuccessIntro: 'Il tuo bonifico è stato eseguito.', receiptFailedIntro: 'Il tuo bonifico è fallito.', receiptCancelledIntro: 'Il tuo bonifico è stato annullato.', disclaimerTitle: 'Riservatezza:', disclaimer: 'Le informazioni sono destinate esclusivamente al destinatario.',
  ...
  de: { logoText: 'YOUNITED', welcomeSubject: 'Ihre Zugangsdaten - YOUNITED', welcomeGreeting: 'Sehr geehrte(r)', welcomeIntro: 'Wir freuen uns, Ihnen die Kontoeröffnung zu bestätigen.', welcomeThanks: 'Wir danken Ihnen für Ihr Vertrauen.', welcomeAccess: 'Um auf Ihren Kundenbereich zuzugreifen:', welcomeIdentifier: 'Benutzername', welcomePin: 'PIN-Code', welcomeButton: 'Auf mein Konto zugreifen', welcomeSignature: 'Mit freundlichen Grüßen.', activationSubject: 'Aktivierungscode - YOUNITED', activationIntro: 'Der Aktivierungscode lautet:', receiptSubject: 'Überweisungsbestätigung - YOUNITED', receiptFailedSubject: 'Überweisung fehlgeschlagen - YOUNITED', receiptCancelSubject: 'Überweisung storniert - YOUNITED', receiptTitle: 'Überweisung ausgeführt', receiptFailedTitle: 'Überweisung fehlgeschlagen', receiptCancelTitle: 'Überweisung storniert', receiptAmount: 'BETRAG', receiptBeneficiary: 'Begünstigter', receiptIban: 'IBAN', receiptBank: 'Bank', receiptSwift: 'SWIFT / BIC', receiptDate: 'Datum', receiptStatus: 'Status', receiptStatusDone: 'Abgeschlossen', receiptStatusFailed: 'Fehlgeschlagen bei {percent}%', receiptStatusCancelled: 'Storniert', receiptReason: 'Grund', receiptReference: 'Referenz', receiptSuccessIntro: 'Ihre Überweisung wurde erfolgreich ausgeführt.', receiptFailedIntro: 'Ihre Überweisung ist fehlgeschlagen.', receiptCancelledIntro: 'Ihre Überweisung wurde storniert.', disclaimerTitle: 'Vertraulichkeitshinweis:', disclaimer: 'Die Informationen sind ausschließlich für den Empfänger bestimmt.',
...
// ========== WRAPPER EXISTANT (utilisé pour les emails identifiants et code d'activation UNIQUEMENT) ==========
...
// ========== EMAIL IDENTIFIANTS (NON MODIFIÉ) ==========
...
// ========== EMAIL CODE D'ACTIVATION (NON MODIFIÉ) ==========
...
// ================= NOUVEAU : Helper email de transfert (compact, plein écran) =================
...
// ================= 1) Virement effectué / échoué (ROUGE) =================
...
function buildPendingTransferEmail(client, tx, lang) {
  ...
  return buildTransferEmailShell({
    ...
    infoTitle: lang === 'fr' ? 'Que se passe-t-il ensuite ?' : 'Next',
    infoText: T.pendingTransferEmailBody
  });
}

// ================= 3) Virement validé (ROUGE) =================
...
// ================= 4) Virement annulé / remboursé (BLEU) =================
