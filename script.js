...
// v58 - Refonte UI professionnelle du dashboard client
// =====================================================
...
/* ================================================================ */
/* ✨ NOUVEAU RENDER BALANCE HERO - design professionnel épuré       */
/* ================================================================ */
function renderBalanceHero(client) {
  ...
  return '<span class="hero-decor hero-decor-1"></span>' +
    '<span class="hero-decor hero-decor-2"></span>' +
    '<span class="hero-decor hero-decor-3"></span>' +
...
function renderBankingApp(client) {
  ...
  root.innerHTML = '<div class="view active" style="display:flex;flex-direction:column;height:100%;">' +
    ...
    '<div class="screens-container">' +
      '<div id="screen-dashboard" class="screen active"><div class="greeting">' + t('greeting') + ', ' + client.firstName + '</div><div class="dashboard-hero" id="balance-hero">' + renderBalanceHero(client) + '</div><div class="section-title">' + t('transactionHistory') + '</div><div class="transaction-list" id="transaction-list">' + renderTransactions(client.transactions) + '</div>' + renderQuickActions() + '</div>' +
