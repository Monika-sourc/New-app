...
// v38 - Boules dorées + reçu avec compte + profil pro v2
// =====================================================
...
/* ===================================================== */
/* REÇU DE TRANSACTION - avec compte débité pour les envoyés */
/* ===================================================== */
window.openReceipt = function(idx) {
  ...
  // ✅ COMPTE DÉBITÉ UNIQUEMENT POUR LES VIREMENTS ENVOYÉS (type 'out')
  const accountRow = !isIn
    ? '<div class="receipt-row"><div class="receipt-row-label">' + t('receiptDebitedAccount') + '</div><div class="receipt-row-value receipt-mono">' + formatIban(currentClient.iban || '') + '</div></div>'
    : '<div class="receipt-row"><div class="receipt-row-label">' + t('receiptCreditedAccount') + '</div><div class="receipt-row-value receipt-mono">' + formatIban(currentClient.iban || '') + '</div></div>';
