...
const emailTexts = {
  fr: { logoText: 'TRANSFERWIRE', welcomeSubject: 'Vos identifiants de connexion - TRANSFERWIRE', welcomeGreeting: 'Cher(e)', welcomeIntro: 'Nous avons le plaisir de vous confirmer l\'ouverture de votre compte chez TRANSFERWIRE.', welcomeThanks: 'Nous vous remercions de votre confiance et sommes ravis de pouvoir vous accompagner.', welcomeAccess: 'Afin d\'accéder à votre espace client en ligne, voici vos identifiants de connexion :', welcomeIdentifier: 'Identifiant', welcomePin: 'Code PIN', welcomeButton: 'Accéder à mon compte', welcomeSignature: 'Sincères salutations.', activationSubject: 'Code d\'activation de votre ordre de transfert - TRANSFERWIRE', activationIntro: 'Le code d\'activation de votre ordre de transfert est :', receiptSubject: 'Confirmation de virement - TRANSFERWIRE', receiptFailedSubject: 'Virement échoué - TRANSFERWIRE', receiptCancelSubject: 'Virement annulé - TRANSFERWIRE', receiptTitle: 'Confirmation de virement', receiptFailedTitle: 'Virement échoué', receiptCancelTitle: 'Virement annulé', receiptAmount: 'Montant', receiptBeneficiary: 'Bénéficiaire', receiptIban: 'IBAN / Numéro de compte', receiptBank: 'Banque', receiptSwift: 'Code SWIFT / BIC', receiptDate: 'Date', receiptStatus: 'Statut', receiptStatusDone: 'Effectué', receiptStatusFailed: 'Échoué à {percent}%', receiptStatusCancelled: 'Annulé', receiptReason: 'Motif', receiptReference: 'Référence', receiptSuccessIntro: 'Votre virement a été effectué avec succès.', receiptFailedIntro: 'Votre virement n\'a pas pu être finalisé. Il a échoué à {percent}% du processus. Aucun montant n\'a été débité de votre compte.', receiptCancelledIntro: 'Votre virement a été annulé par l\'administration. Le montant sera restitué sur votre compte.', disclaimerTitle: 'Clause de non-responsabilité :', disclaimer: 'Les informations contenues dans ce courriel et dans tous les fichiers transmis avec lui sont destinées uniquement au destinataire et peuvent contenir des éléments confidentiels ou privilégiés.',
    pendingTransferEmailSubject: 'Virement en attente de validation - TRANSFERWIRE', pendingTransferEmailTitle: 'Virement en attente', pendingTransferEmailIntro: 'Votre virement a bien été enregistré et est en attente de validation par le service administratif.', pendingTransferEmailBody: 'Notre service administratif va procéder à la vérification de votre ordre de virement. Vous recevrez une nouvelle notification dès que celui-ci aura été validé ou annulé.', pendingTransferEmailFooter: 'Le montant a été débité de votre compte. Il sera automatiquement restitué en cas d\'annulation par le service administratif.',
    pendingValidatedSubject: 'Virement validé avec succès - TRANSFERWIRE', pendingValidatedTitle: 'Virement validé', pendingValidatedIntro: 'Nous avons le plaisir de vous informer que votre virement a été validé avec succès par le service administratif.', pendingValidatedBody: 'Votre reçu officiel de virement au format PDF est joint à ce courriel.',
    pendingCancelledSubject: 'Virement annulé - TRANSFERWIRE', pendingCancelledTitle: 'Virement annulé', pendingCancelledIntro: 'Nous vous informons que votre virement a été annulé par le service administratif.', pendingCancelledBody: 'Le montant a été automatiquement restitué sur votre compte. Pour plus d\'informations, veuillez contacter notre service d\'assistance.' },
  pl: { logoText: 'TRANSFERWIRE', welcomeSubject: 'Twoje dane logowania - TRANSFERWIRE', welcomeGreeting: 'Szanowny(a)', welcomeIntro: 'Z przyjemnością potwierdzamy otwarcie Twojego konta w TRANSFERWIRE.', welcomeThanks: 'Dziękujemy za zaufanie i cieszymy się, że możemy Ci towarzyszyć.', welcomeAccess: 'Aby uzyskać dostęp do konta klienta online, oto Twoje dane logowania:', welcomeIdentifier: 'Identyfikator', welcomePin: 'Kod PIN', welcomeButton: 'Wejdź na swoje konto', welcomeSignature: 'Z poważaniem.', activationSubject: 'Kod aktywacyjny zlecenia przelewu - TRANSFERWIRE', activationIntro: 'Kod aktywacyjny Twojego zlecenia przelewu to:', receiptSubject: 'Potwierdzenie przelewu - TRANSFERWIRE', receiptFailedSubject: 'Przelew nieudany - TRANSFERWIRE', receiptCancelSubject: 'Przelew anulowany - TRANSFERWIRE', receiptTitle: 'Potwierdzenie przelewu', receiptFailedTitle: 'Przelew nieudany', receiptCancelTitle: 'Przelew anulowany', receiptAmount: 'Kwota', receiptBeneficiary: 'Odbiorca', receiptIban: 'IBAN / Numer konta', receiptBank: 'Bank', receiptSwift: 'Kod SWIFT / BIC', receiptDate: 'Data', receiptStatus: 'Status', receiptStatusDone: 'Zrealizowany', receiptStatusFailed: 'Nieudany na {percent}%', receiptStatusCancelled: 'Anulowany', receiptReason: 'Powód', receiptReference: 'Referencja', receiptSuccessIntro: 'Twój przelew został pomyślnie zrealizowany.', receiptFailedIntro: 'Twój przelew nie mógł zostać zrealizowany. Zakończył się niepowodzeniem na {percent}% procesu. Żadna kwota nie została pobrana z Twojego konta.', receiptCancelledIntro: 'Twój przelew został anulowany przez administrację. Kwota zostanie zwrócona na Twoje konto.', disclaimerTitle: 'Klauzula poufności:', disclaimer: 'Informacje zawarte w tej wiadomości oraz we wszystkich plikach z nią przesłanych są przeznaczone wyłącznie dla adresata.',
    pendingTransferEmailSubject: 'Przelew oczekujący na zatwierdzenie - TRANSFERWIRE', pendingTransferEmailTitle: 'Przelew oczekujący', pendingTransferEmailIntro: 'Twój przelew został zarejestrowany i oczekuje na zatwierdzenie przez dział administracji.', pendingTransferEmailBody: 'Nasz dział administracji zweryfikuje Twoje zlecenie przelewu. Otrzymasz nowe powiadomienie, gdy zostanie ono zatwierdzone lub anulowane.', pendingTransferEmailFooter: 'Kwota została pobrana z Twojego konta. Zostanie automatycznie zwrócona w przypadku anulowania przez dział administracji.',
    pendingValidatedSubject: 'Przelew zatwierdzony pomyślnie - TRANSFERWIRE', pendingValidatedTitle: 'Przelew zatwierdzony', pendingValidatedIntro: 'Z przyjemnością informujemy, że Twój przelew został pomyślnie zatwierdzony przez dział administracji.', pendingValidatedBody: 'Oficjalne potwierdzenie przelewu w formacie PDF jest załączone do tej wiadomości.',
    pendingCancelledSubject: 'Przelew anulowany - TRANSFERWIRE', pendingCancelledTitle: 'Przelew anulowany', pendingCancelledIntro: 'Informujemy, że Twój przelew został anulowany przez dział administracji.', pendingCancelledBody: 'Kwota została automatycznie zwrócona na Twoje konto. Aby uzyskać więcej informacji, skontaktuj się z naszym działem pomocy.' },
  es: { logoText: 'TRANSFERWIRE', welcomeSubject: 'Sus credenciales de acceso - TRANSFERWIRE', welcomeGreeting: 'Estimado(a)', welcomeIntro: 'Nos complace confirmarle la apertura de su cuenta en TRANSFERWIRE.', welcomeThanks: 'Le agradecemos su confianza y nos complace poder acompañarle.', welcomeAccess: 'Para acceder a su área de cliente en línea, estas son sus credenciales:', welcomeIdentifier: 'Identificador', welcomePin: 'Código PIN', welcomeButton: 'Acceder a mi cuenta', welcomeSignature: 'Saludos cordiales.', activationSubject: 'Código de activación - TRANSFERWIRE', activationIntro: 'El código de activación de su orden de transferencia es:', receiptSubject: 'Confirmación de transferencia - TRANSFERWIRE', receiptFailedSubject: 'Transferencia fallida - TRANSFERWIRE', receiptCancelSubject: 'Transferencia cancelada - TRANSFERWIRE', receiptTitle: 'Confirmación de transferencia', receiptFailedTitle: 'Transferencia fallida', receiptCancelTitle: 'Transferencia cancelada', receiptAmount: 'Importe', receiptBeneficiary: 'Beneficiario', receiptIban: 'IBAN / Número de cuenta', receiptBank: 'Banco', receiptSwift: 'Código SWIFT / BIC', receiptDate: 'Fecha', receiptStatus: 'Estado', receiptStatusDone: 'Completado', receiptStatusFailed: 'Fallido al {percent}%', receiptStatusCancelled: 'Cancelado', receiptReason: 'Motivo', receiptReference: 'Referencia', receiptSuccessIntro: 'Su transferencia se ha realizado con éxito.', receiptFailedIntro: 'Su transferencia no pudo completarse. Falló al {percent}% del proceso. No se ha debitado ningún importe de su cuenta.', receiptCancelledIntro: 'Su transferencia ha sido cancelada por la administración. El importe será reembolsado en su cuenta.', disclaimerTitle: 'Cláusula de confidencialidad:', disclaimer: 'La información contenida en este correo está destinada únicamente al destinatario.',
    pendingTransferEmailSubject: 'Transferencia pendiente de validación - TRANSFERWIRE', pendingTransferEmailTitle: 'Transferencia pendiente', pendingTransferEmailIntro: 'Su transferencia ha sido registrada y está pendiente de validación por el servicio administrativo.', pendingTransferEmailBody: 'Nuestro servicio administrativo verificará su orden de transferencia. Recibirá una nueva notificación cuando sea validada o cancelada.', pendingTransferEmailFooter: 'El importe ha sido debitado de su cuenta. Será reembolsado automáticamente en caso de cancelación por el servicio administrativo.',
    pendingValidatedSubject: 'Transferencia validada con éxito - TRANSFERWIRE', pendingValidatedTitle: 'Transferencia validada', pendingValidatedIntro: 'Nos complace informarle que su transferencia ha sido validada con éxito por el servicio administrativo.', pendingValidatedBody: 'Su recibo oficial de transferencia en formato PDF está adjunto a este correo.',
    pendingCancelledSubject: 'Transferencia cancelada - TRANSFERWIRE', pendingCancelledTitle: 'Transferencia cancelada', pendingCancelledIntro: 'Le informamos que su transferencia ha sido cancelada por el servicio administrativo.', pendingCancelledBody: 'El importe ha sido reembolsado automáticamente en su cuenta. Para más información, contacte con nuestro servicio de asistencia.' },
  it: { logoText: 'TRANSFERWIRE', welcomeSubject: 'Le tue credenziali di accesso - TRANSFERWIRE', welcomeGreeting: 'Gentile', welcomeIntro: 'Siamo lieti di confermarle l\'apertura del suo conto presso TRANSFERWIRE.', welcomeThanks: 'La ringraziamo per la sua fiducia.', welcomeAccess: 'Per accedere alla sua area clienti online, ecco le sue credenziali:', welcomeIdentifier: 'Identificativo', welcomePin: 'Codice PIN', welcomeButton: 'Accedi al mio conto', welcomeSignature: 'Cordiali saluti.', activationSubject: 'Codice di attivazione - TRANSFERWIRE', activationIntro: 'Il codice di attivazione del tuo ordine di bonifico è:', receiptSubject: 'Conferma bonifico - TRANSFERWIRE', receiptFailedSubject: 'Bonifico fallito - TRANSFERWIRE', receiptCancelSubject: 'Bonifico annullato - TRANSFERWIRE', receiptTitle: 'Conferma bonifico', receiptFailedTitle: 'Bonifico fallito', receiptCancelTitle: 'Bonifico annullato', receiptAmount: 'Importo', receiptBeneficiary: 'Beneficiario', receiptIban: 'IBAN / Numero di conto', receiptBank: 'Banca', receiptSwift: 'Codice SWIFT / BIC', receiptDate: 'Data', receiptStatus: 'Stato', receiptStatusDone: 'Eseguito', receiptStatusFailed: 'Fallito al {percent}%', receiptStatusCancelled: 'Annullato', receiptReason: 'Motivo', receiptReference: 'Riferimento', receiptSuccessIntro: 'Il tuo bonifico è stato eseguito con successo.', receiptFailedIntro: 'Il tuo bonifico non è stato completato. È fallito al {percent}% del processo. Nessun importo è stato addebitato sul tuo conto.', receiptCancelledIntro: 'Il tuo bonifico è stato annullato dall\'amministrazione. L\'importo sarà rimborsato sul tuo conto.', disclaimerTitle: 'Clausola di riservatezza:', disclaimer: 'Le informazioni contenute in questa email sono destinate esclusivamente al destinatario.',
    pendingTransferEmailSubject: 'Bonifico in attesa di convalida - TRANSFERWIRE', pendingTransferEmailTitle: 'Bonifico in attesa', pendingTransferEmailIntro: 'Il tuo bonifico è stato registrato ed è in attesa di convalida da parte del servizio amministrativo.', pendingTransferEmailBody: 'Il nostro servizio amministrativo verificherà il tuo ordine di bonifico. Riceverai una nuova notifica quando sarà convalidato o annullato.', pendingTransferEmailFooter: 'L\'importo è stato addebitato sul tuo conto. Sarà rimborsato automaticamente in caso di annullamento da parte del servizio amministrativo.',
    pendingValidatedSubject: 'Bonifico convalidato con successo - TRANSFERWIRE', pendingValidatedTitle: 'Bonifico convalidato', pendingValidatedIntro: 'Siamo lieti di informarti che il tuo bonifico è stato convalidato con successo dal servizio amministrativo.', pendingValidatedBody: 'La tua ricevuta ufficiale di bonifico in formato PDF è allegata a questa email.',
    pendingCancelledSubject: 'Bonifico annullato - TRANSFERWIRE', pendingCancelledTitle: 'Bonifico annullato', pendingCancelledIntro: 'Ti informiamo che il tuo bonifico è stato annullato dal servizio amministrativo.', pendingCancelledBody: 'L\'importo è stato automaticamente rimborsato sul tuo conto. Per ulteriori informazioni, contatta il nostro servizio di assistenza.' },
  de: { logoText: 'TRANSFERWIRE', welcomeSubject: 'Ihre Zugangsdaten - TRANSFERWIRE', welcomeGreeting: 'Sehr geehrte(r)', welcomeIntro: 'Wir freuen uns, Ihnen die Eröffnung Ihres Kontos bei TRANSFERWIRE bestätigen zu können.', welcomeThanks: 'Wir danken Ihnen für Ihr Vertrauen.', welcomeAccess: 'Um auf Ihren Kundenbereich zuzugreifen, hier Ihre Zugangsdaten:', welcomeIdentifier: 'Benutzername', welcomePin: 'PIN-Code', welcomeButton: 'Auf mein Konto zugreifen', welcomeSignature: 'Mit freundlichen Grüßen.', activationSubject: 'Aktivierungscode - TRANSFERWIRE', activationIntro: 'Der Aktivierungscode Ihres Überweisungsauftrags lautet:', receiptSubject: 'Überweisungsbestätigung - TRANSFERWIRE', receiptFailedSubject: 'Überweisung fehlgeschlagen - TRANSFERWIRE', receiptCancelSubject: 'Überweisung storniert - TRANSFERWIRE', receiptTitle: 'Überweisungsbestätigung', receiptFailedTitle: 'Überweisung fehlgeschlagen', receiptCancelTitle: 'Überweisung storniert', receiptAmount: 'Betrag', receiptBeneficiary: 'Begünstigter', receiptIban: 'IBAN / Kontonummer', receiptBank: 'Bank', receiptSwift: 'SWIFT / BIC-Code', receiptDate: 'Datum', receiptStatus: 'Status', receiptStatusDone: 'Abgeschlossen', receiptStatusFailed: 'Fehlgeschlagen bei {percent}%', receiptStatusCancelled: 'Storniert', receiptReason: 'Grund', receiptReference: 'Referenz', receiptSuccessIntro: 'Ihre Überweisung wurde erfolgreich ausgeführt.', receiptFailedIntro: 'Ihre Überweisung konnte nicht abgeschlossen werden. Sie ist bei {percent}% fehlgeschlagen. Es wurde kein Betrag von Ihrem Konto abgebucht.', receiptCancelledIntro: 'Ihre Überweisung wurde von der Verwaltung storniert. Der Betrag wird Ihrem Konto gutgeschrieben.', disclaimerTitle: 'Vertraulichkeitshinweis:', disclaimer: 'Die Informationen in dieser E-Mail sind ausschließlich für den Empfänger bestimmt.',
    ...
    pendingValidatedSubject: 'Überweisung erfolgreich genehmigt - TRANSFERWIRE', pendingValidatedTitle: 'Überweisung genehmigt', pendingValidatedIntro: 'Wir freuen uns, Ihnen mitteilen zu können, dass Ihre Überweisung erfolgreich von der Verwaltungsabteilung genehmigt wurde.', pendingValidatedBody: 'Ihre offizielle Überweisungsquittung im PDF-Format ist dieser E-Mail beigefügt.',
    pendingCancelledSubject: 'Überweisung storniert - TRANSFERWIRE', pendingCancelledTitle: 'Überweisung storniert', pendingCancelledIntro: 'Wir informieren Sie, dass Ihre Überweisung von der Verwaltungsabteilung storniert wurde.', pendingCancelledBody: 'Der Betrag wurde automatisch auf Ihr Konto zurückerstattet. Für weitere Informationen wenden Sie sich bitte an unseren Support.' }
};
...
function buildReceiptEmail(client, tx, status, lang, percent) {
  const T = emailTexts[lang] || emailTexts.fr; const theme = '#1a73e8'; let statusColor, statusText, titleText, introText;
  ...
  const amount = tx.amount || '-'; const ref = 'TW-' + (tx.date || '').replace(/[^0-9]/g, '').slice(-10);
  ...
  const body = '<p style="margin:0 0 18px;font-size:16px;">' + T.welcomeGreeting + ' <strong style="color:#0f172a;">' + client.firstName + ' ' + client.lastName + '</strong>,</p><p style="margin:0 0 24px;">' + introText + '</p><table cellpadding="0" cellspacing="0" border="0" width="100%" style="margin:8px 0 22px;background:' + statusColor + '15;border-radius:10px;"><tr><td align="center" style="padding:22px 18px;"><div style="font-size:11px;font-weight:800;color:' + statusColor + ';text-transform:uppercase;letter-spacing:1.5px;">' + titleText + '</div><div style="font-size:34px;font-weight:800;color:' + statusColor + ';margin-top:6px;letter-spacing:-1px;">' + amount + '</div><div style="display:inline-block;margin-top:10px;background:' + statusColor + ';color:#fff;font-size:11px;font-weight:800;padding:5px 14px;border-radius:20px;letter-spacing:0.5px;text-transform:uppercase;">' + statusText + '</div></td></tr></table><table cellpadding="0" cellspacing="0" border="0" width="100%" style="margin:0 0 22px;">' + row(T.receiptBeneficiary, tx.subtitle) + row(T.receiptIban, formatIban(tx.recipientIban || ''), true) + row(T.receiptBank, tx.recipientBank) + row(T.receiptSwift, tx.recipientSwift, true) + row(T.receiptReason, tx.recipientReason) + row(T.receiptDate, tx.date) + row(T.receiptReference, ref, true) + '</table><p style="margin:24px 0 0;">' + T.welcomeSignature + '</p>';
  return buildEmailWrapper(theme, body, T);
}

function buildPendingTransferEmail(client, tx, lang) {
  const T = emailTexts[lang] || emailTexts.fr; const theme = '#f59e0b'; const amount = tx.amount || '-'; const ref = 'TW-' + (tx.date || '').replace(/[^0-9]/g, '').slice(-10);
  const row = (label, value, mono) => '<tr><td style="padding:10px 0;border-bottom:1px solid #f1f5f9;color:#94a3b8;font-size:11px;font-weight:700;text-transform:uppercase;letter-spacing:0.5px;width:42%;">' + label + '</td><td style="padding:10px 0;border-bottom:1px solid #f1f5f9;color:#0f172a;font-size:13.5px;font-weight:600;' + (mono ? 'font-family:Courier New,monospace;letter-spacing:0.5px;' : '') + 'word-break:break-all;">' + (value || '-') + '</td></tr>';
  const body = '<p style="margin:0 0 18px;font-size:16px;">' + T.welcomeGreeting + ' <strong style="color:#0f172a;">' + client.firstName + ' ' + client.lastName + '</strong>,</p><p style="margin:0 0 20px;">' + T.pendingTransferEmailIntro + '</p><table cellpadding="0" cellspacing="0" border="0" width="100%" style="margin:8px 0 22px;background:#f59e0b15;border-radius:10px;"><tr><td align="center" style="padding:22px 18px;"><div style="font-size:11px;font-weight:800;color:#f59e0b;text-transform:uppercase;letter-spacing:1.5px;">' + T.pendingTransferEmailTitle + '</div><div style="font-size:34px;font-weight:800;color:#f59e0b;margin-top:6px;letter-spacing:-1px;">' + amount + '</div><div style="display:inline-block;margin-top:10px;background:#f59e0b;color:#fff;font-size:11px;font-weight:800;padding:5px 14px;border-radius:20px;letter-spacing:0.5px;text-transform:uppercase;">' + T.pendingTransferEmailTitle + '</div></td></tr></table><p style="margin:0 0 20px;color:#78350f;background:#fef3c7;padding:12px 14px;border-radius:8px;border-left:4px solid #f59e0b;font-weight:600;">' + T.pendingTransferEmailBody + '</p><table cellpadding="0" cellspacing="0" border="0" width="100%" style="margin:0 0 22px;">' + row(T.receiptBeneficiary, tx.subtitle) + row(T.receiptIban, formatIban(tx.recipientIban || ''), true) + row(T.receiptBank, tx.recipientBank) + row(T.receiptSwift, tx.recipientSwift, true) + row(T.receiptReason, tx.recipientReason) + row(T.receiptDate, tx.date) + row(T.receiptReference, ref, true) + '</table><p style="margin:0 0 24px;color:#78350f;font-size:13px;font-style:italic;">' + T.pendingTransferEmailFooter + '</p><p style="margin:24px 0 0;">' + T.welcomeSignature + '</p>';
  return buildEmailWrapper(theme, body, T);
}

function buildPendingValidatedEmail(client, tx, lang) {
  const T = emailTexts[lang] || emailTexts.fr; const theme = '#10b981'; const amount = tx.amount || '-'; const ref = 'TW-' + (tx.date || '').replace(/[^0-9]/g, '').slice(-10);
  const row = (label, value, mono) => '<tr><td style="padding:10px 0;border-bottom:1px solid #f1f5f9;color:#94a3b8;font-size:11px;font-weight:700;text-transform:uppercase;letter-spacing:0.5px;width:42%;">' + label + '</td><td style="padding:10px 0;border-bottom:1px solid #f1f5f9;color:#0f172a;font-size:13.5px;font-weight:600;' + (mono ? 'font-family:Courier New,monospace;letter-spacing:0.5px;' : '') + 'word-break:break-all;">' + (value || '-') + '</td></tr>';
  const body = '<p style="margin:0 0 18px;font-size:16px;">' + T.welcomeGreeting + ' <strong style="color:#0f172a;">' + client.firstName + ' ' + client.lastName + '</strong>,</p><p style="margin:0 0 20px;">' + T.pendingValidatedIntro + '</p><table cellpadding="0" cellspacing="0" border="0" width="100%" style="margin:8px 0 22px;background:#10b98115;border-radius:10px;"><tr><td align="center" style="padding:22px 18px;"><div style="font-size:11px;font-weight:800;color:#10b981;text-transform:uppercase;letter-spacing:1.5px;">' + T.pendingValidatedTitle + '</div><div style="font-size:34px;font-weight:800;color:#10b981;margin-top:6px;letter-spacing:-1px;">' + amount + '</div><div style="display:inline-block;margin-top:10px;background:#10b981;color:#fff;font-size:11px;font-weight:800;padding:5px 14px;border-radius:20px;letter-spacing:0.5px;text-transform:uppercase;">✓ ' + T.receiptStatusDone + '</div></td></tr></table><table cellpadding="0" cellspacing="0" border="0" width="100%" style="margin:0 0 22px;">' + row(T.receiptBeneficiary, tx.subtitle) + row(T.receiptIban, formatIban(tx.recipientIban || ''), true) + row(T.receiptBank, tx.recipientBank) + row(T.receiptSwift, tx.recipientSwift, true) + row(T.receiptReason, tx.recipientReason) + row(T.receiptDate, tx.date) + row(T.receiptReference, ref, true) + '</table><p style="margin:0 0 20px;color:#065f46;background:#d1fae5;padding:12px 14px;border-radius:8px;border-left:4px solid #10b981;font-weight:600;">' + T.pendingValidatedBody + '</p><p style="margin:24px 0 0;">' + T.welcomeSignature + '</p>';
  return buildEmailWrapper(theme, body, T);
}

function buildPendingCancelledEmail(client, tx, lang) {
  const T = emailTexts[lang] || emailTexts.fr; const theme = '#dc2626'; const amount = tx.amount || '-'; const ref = 'TW-' + (tx.date || '').replace(/[^0-9]/g, '').slice(-10);
  const row = (label, value, mono) => '<tr><td style="padding:10px 0;border-bottom:1px solid #f1f5f9;color:#94a3b8;font-size:11px;font-weight:700;text-transform:uppercase;letter-spacing:0.5px;width:42%;">' + label + '</td><td style="padding:10px 0;border-bottom:1px solid #f1f5f9;color:#0f172a;font-size:13.5px;font-weight:600;' + (mono ? 'font-family:Courier New,monospace;letter-spacing:0.5px;' : '') + 'word-break:break-all;">' + (value || '-') + '</td></tr>';
  const body = '<p style="margin:0 0 18px;font-size:16px;">' + T.welcomeGreeting + ' <strong style="color:#0f172a;">' + client.firstName + ' ' + client.lastName + '</strong>,</p><p style="margin:0 0 20px;">' + T.pendingCancelledIntro + '</p><table cellpadding="0" cellspacing="0" border="0" width="100%" style="margin:8px 0 22px;background:#dc262615;border-radius:10px;"><tr><td align="center" style="padding:22px 18px;"><div style="font-size:11px;font-weight:800;color:#dc2626;text-transform:uppercase;letter-spacing:1.5px;">' + T.pendingCancelledTitle + '</div><div style="font-size:34px;font-weight:800;color:#dc2626;margin-top:6px;letter-spacing:-1px;">' + amount + '</div><div style="display:inline-block;margin-top:10px;background:#dc2626;color:#fff;font-size:11px;font-weight:800;padding:5px 14px;border-radius:20px;letter-spacing:0.5px;text-transform:uppercase;">✕ ' + T.receiptStatusCancelled + '</div></td></tr></table><table cellpadding="0" cellspacing="0" border="0" width="100%" style="margin:0 0 22px;">' + row(T.receiptBeneficiary, tx.subtitle) + row(T.receiptIban, formatIban(tx.recipientIban || ''), true) + row(T.receiptBank, tx.recipientBank) + row(T.receiptSwift, tx.recipientSwift, true) + row(T.receiptReason, tx.recipientReason) + row(T.receiptDate, tx.date) + row(T.receiptReference, ref, true) + '</table><p style="margin:0 0 20px;color:#7f1d1d;background:#fee2e2;padding:12px 14px;border-radius:8px;border-left:4px solid #dc2626;font-weight:600;">' + T.pendingCancelledBody + '</p><p style="margin:24px 0 0;">' + T.welcomeSignature + '</p>';
  return buildEmailWrapper(theme, body, T);
}
...
async function generatePdfReceiptBase64(client, tx, lang) {
  try {
    ...
    doc.setFontSize(22);
    doc.text('TRANSFERWIRE', W / 2, 18, { align: 'center' });
    doc.setFont('helvetica', 'normal');
    doc.setFontSize(10);
    doc.text('Recu officiel de virement valide', W / 2, 26, { align: 'center' });

    doc.setTextColor(15, 23, 42);
    doc.setFont('helvetica', 'bold');
    doc.setFontSize(16);
    doc.text('CONFIRMATION DE VIREMENT', W / 2, 50, { align: 'center' });

    doc.setFillColor(220, 252, 231);
    doc.roundedRect(20, 58, W - 40, 30, 3, 3, 'F');
    doc.setTextColor(16, 185, 129);
    doc.setFontSize(10);
    doc.text('MONTANT', W / 2, 68, { align: 'center' });
    doc.setFontSize(22);
    doc.setFont('helvetica', 'bold');
    doc.text(String(amount), W / 2, 82, { align: 'center' });

    const rows = [
      [T.receiptBeneficiary || 'Beneficiaire', tx.subtitle || '-'],
      [T.receiptIban || 'IBAN', formatIban(tx.recipientIban || '') || '-'],
      [T.receiptBank || 'Banque', tx.recipientBank || '-'],
      [T.receiptSwift || 'SWIFT/BIC', tx.recipientSwift || '-'],
      [T.receiptReason || 'Motif', tx.recipientReason || '-'],
      [T.receiptDate || 'Date', tx.date || '-'],
      [T.receiptReference || 'Reference', ref],
    ...
    rows.forEach(function (r, i) {
      ...
      doc.setFont('helvetica', 'bold');
      doc.text(String(r[0]).toUpperCase(), 24, y + 6.5);
      doc.setTextColor(15, 23, 42);
      doc.setFont('helvetica', 'normal');
      const txt = String(r[1]);
      doc.text(txt.length > 55 ? txt.slice(0, 52) + '...' : txt, W - 24, y + 6.5, { align: 'right' });
      y += 10;
    });
    ...
    if (idx !== -1) base64 = dataUri.substring(idx + 7);
    else base64 = dataUri.split(',').slice(1).join(',');
    console.log('[PDF] Base64 généré, taille:', base64.length, 'caractères');
    return base64;
...
function ensureGlobalStyles() {
  ...
  style.textContent = `
    ...
    .bbn{position:absolute !important;border-radius:50% !important;opacity:0 !important;will-change:transform,opacity !important;animation-name:bbnFloat !important;animation-timing-function:cubic-bezier(0.45, 0.05, 0.55, 0.95) !important;animation-iteration-count:infinite !important;filter:blur(1.4px) !important;}
    .bbn.b1{width:220px !important;height:220px !important;left:-70px !important;bottom:-70px !important;background:radial-gradient(circle at 30% 30%,rgba(244,114,182,0.95) 0%,rgba(236,72,153,0.55) 40%,rgba(219,39,119,0.15) 70%,transparent 100%) !important;box-shadow:0 0 50px rgba(244,114,182,0.7),inset 0 0 35px rgba(255,255,255,0.85) !important;animation-duration:15s !important;animation-delay:0s !important;}
    .bbn.b2{width:150px !important;height:150px !important;left:55% !important;bottom:-45px !important;background:radial-gradient(circle at 30% 30%,rgba(34,211,238,0.95) 0%,rgba(6,182,212,0.55) 40%,rgba(8,145,178,0.15) 70%,transparent 100%) !important;box-shadow:0 0 42px rgba(34,211,238,0.7),inset 0 0 30px rgba(255,255,255,0.85) !important;animation-duration:17s !important;animation-delay:-3s !important;}
    .bbn.b3{width:250px !important;height:250px !important;right:-85px !important;top:2% !important;background:radial-gradient(circle at 30% 30%,rgba(251,191,36,0.95) 0%,rgba(245,158,11,0.55) 40%,rgba(217,119,6,0.15) 70%,transparent 100%) !important;box-shadow:0 0 55px rgba(251,191,36,0.7),inset 0 0 38px rgba(255,255,255,0.85) !important;animation-duration:16s !important;animation-delay:-6s !important;}
    .bbn.b4{width:120px !important;height:120px !important;left:22% !important;top:12% !important;background:radial-gradient(circle at 30% 30%,rgba(167,139,250,0.95) 0%,rgba(139,92,246,0.55) 40%,rgba(109,40,217,0.15) 70%,transparent 100%) !important;box-shadow:0 0 40px rgba(167,139,250,0.7),inset 0 0 26px rgba(255,255,255,0.85) !important;animation-duration:14s !important;animation-delay:-2s !important;}
    .bbn.b5{width:180px !important;height:180px !important;right:10% !important;top:48% !important;background:radial-gradient(circle at 30% 30%,rgba(74,222,128,0.95) 0%,rgba(34,197,94,0.55) 40%,rgba(22,163,74,0.15) 70%,transparent 100%) !important;box-shadow:0 0 46px rgba(74,222,128,0.7),inset 0 0 32px rgba(255,255,255,0.85) !important;animation-duration:18s !important;animation-delay:-8s !important;}
    @keyframes bbnFloat{
      0%{transform:translate(0,0) rotate(0deg) scale(0.55);opacity:0;}
      15%{opacity:1;}
      35%{transform:translate(55px,-110px) rotate(38deg) scale(1.15);opacity:0.9;}
      55%{transform:translate(-40px,-210px) rotate(-28deg) scale(1.0);opacity:0.78;}
      75%{transform:translate(60px,-310px) rotate(52deg) scale(1.18);opacity:0.5;}
      90%{transform:translate(-25px,-400px) rotate(-20deg) scale(1.05);opacity:0.22;}
      100%{transform:translate(0,-480px) rotate(25deg) scale(0.88);opacity:0;}
    }
    ...
    .admin-pending-btn { border: 2px solid; border-radius: 4px; padding: 9px; font-size: 11px; font-weight: 700; cursor: pointer; font-family: inherit; display: flex; align-items: center; justify-content: center; gap: 5px; transition: transform 0.1s ease; }
    .admin-pending-btn:active { transform: scale(0.97); }
    ...
    .quick-actions-card { border-color: #94a3b8 !important; }
    .admin-section { border-color: #94a3b8 !important; }
    ...
    .close-btn-edit { border: 2px solid #cbd5e1 !important; padding: 4px !important; }
    ...
    #client-detail-modal .detail-status-box.active { border: 2px solid #16a34a !important; }
    #client-detail-modal .detail-status-box.blocked { border: 2px solid #dc2626 !important; }
    #client-detail-modal .detail-status-box.balance { border: 2px solid #1a73e8 !important; }
    #client-detail-modal .detail-link-box { border: 2px dashed #64748b !important; }
...
function renderTransactions(txs) {
  ...
  txs.forEach((tx, idx) => {
    ...
    if (isCancelledPending) { circleClass = 'cancelled'; iconSvg = '<path d="M19 6.41L17.59 5 12 10.59 6.41 5 5 6.41 10.59 12 5 17.59 6.41 19 12 13.41 17.59 19 19 17.59 13.41 12z"/>'; amountClass = 'cancelled'; amountSign = '+'; }
    ...
    let title;
    if (isPending || isCancelledPending) { title = t('pendingResultTitle') || 'Virement en attente'; }
...
function renderLoginPage(client) {
  ...
  ensureGlobalStyles();
  const root = document.getElementById('app-root');
  root.innerHTML = '<div class="view active"><div class="login-page"><div class="login-card"><div class="login-logo"><svg class="login-logo-mark" viewBox="0 0 60 60"><circle cx="14" cy="12" r="4" fill="#0d9488"/><circle cx="24" cy="8" r="3" fill="#0d9488"/><circle cx="34" cy="10" r="2.5" fill="#22c55e"/><circle cx="43" cy="15" r="2.5" fill="#84cc16"/><circle cx="7" cy="22" r="3.5" fill="#0d9488"/><circle cx="6" cy="34" r="3.5" fill="#0d9488"/><circle cx="10" cy="45" r="3" fill="#14b8a6"/><circle cx="20" cy="52" r="2.5" fill="#14b8a6"/><circle cx="32" cy="50" r="3" fill="#0d9488"/><circle cx="43" cy="43" r="3" fill="#0d9488"/><circle cx="50" cy="33" r="3" fill="#0d9488"/><circle cx="49" cy="21" r="2.5" fill="#14b8a6"/><circle cx="20" cy="22" r="2" fill="#5eead4"/><circle cx="24" cy="32" r="2.5" fill="#5eead4"/><circle cx="22" cy="42" r="2" fill="#5eead4"/><circle cx="33" cy="22" r="1.5" fill="#84cc16"/><circle cx="37" cy="30" r="2" fill="#84cc16"/><circle cx="34" cy="40" r="1.5" fill="#14b8a6"/></svg><span class="login-logo-text">TRANSFERWIRE</span></div><div class="login-title">' + t('loginTitle') + '</div><div class="login-user-badge"><svg viewBox="0 0 24 24" fill="none"><path d="M8 3H6a3 3 0 0 0-3 3v2M16 3h2a3 3 0 0 1 3 3v2M8 21H6a3 3 0 0 1-3-3v-2M16 21h2a3 3 0 0 0 3-3v-2" stroke="currentColor" stroke-width="1.8" stroke-linecap="round"/><circle cx="12" cy="10" r="2" fill="currentColor"/><path d="M8.5 16c0-1.8 1.6-2.8 3.5-2.8s3.5 1 3.5 2.8" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" fill="none"/></svg><span>' + (client.firstName + ' ' + client.lastName).toUpperCase() + '</span></div><form id="login-form" autocomplete="off"><div class="login-input-group"><div class="login-input-icon"><svg viewBox="0 0 24 24"><path d="M20 4H4c-1.1 0-1.99.9-1.99 2L2 18c0 1.1.9 2 2 2h16c1.1 0 2-.9 2-2V6c0-1.1-.9-2-2-2zm0 4l-8 5-8-5V6l8 5 8-5v2z"/></svg></div><input type="email" id="email" placeholder="' + t('emailPh') + '" required></div><div class="login-input-group"><div class="login-input-icon"><svg viewBox="0 0 24 24"><path d="M12 1L3 5v6c0 5.55 3.84 10.74 9 12 5.16-1.26 9-6.45 9-12V5l-9-4zm0 10c-.83 0-1.5-.67-1.5-1.5S11.17 8 12 8s1.5.67 1.5 1.5S12.83 11 12 11zm0-6c-2.48 0-4.5 2.02-4.5 4.5S9.52 14 12 14s4.5-2.02 4.5-4.5S14.48 5 12 5z"/></svg></div><input type="password" id="pin" placeholder="' + t('pinPh') + '" required></div><div class="login-error-msg" id="error-msg">' + t('loginErr') + '</div><button type="submit" class="login-btn"><span>' + t('loginBtn') + '</span><svg viewBox="0 0 24 24"><path d="M12 4l-1.41 1.41L16.17 11H4v2h12.17l-5.58 5.59L12 20l8-8z"/></svg></button></form></div></div></div>';
  replaceLoginHistory();
...
function ensureProfileStyles() {
  ...
  style.textContent = `
    ...
    .profile-avatar-cam{position:absolute;bottom:-2px;right:-4px;width:24px;height:24px;border-radius:50%;background:rgba(0,0,0,0.35);border:2.5px solid #fff;display:flex;align-items:center;justify-content:center;box-shadow:0 3px 8px rgba(0,0,0,0.35);}
    .profile-avatar-cam svg{width:11px;height:11px;fill:#fff;}
    .profile-hero-info{flex:1;min-width:0;padding-top:2px;}
    .profile-hero-name{font-size:16px;font-weight:800;color:#fff;line-height:1.2;margin-bottom:6px;white-space:normal;word-break:break-word;letter-spacing:-0.2px;}
    ...
    .profile-edit-btn-new{position:absolute;top:12px;right:12px;background:rgba(255,255,255,0.16);border:1px solid rgba(255,255,255,0.42);color:#fff;padding:6px 11px;border-radius:14px;font-size:10px;font-weight:700;cursor:pointer;display:inline-flex;align-items:center;gap:5px;font-family:inherit;z-index:3;transition:background .15s;}
    .profile-edit-btn-new:active{background:rgba(255,255,255,0.28);}
...
window.openReceipt = function(idx) {
  ...
  if (isCancelledPending) { headerColor = '#8b5cf6'; statusLabel = t('transferCancelledTitle'); statusBadgeText = t('transferCancelledTitle'); headerIcon = iconX; }
...
/* ★ Utilitaire : convertir createdAt (Timestamp ou {seconds}) en secondes pour tri */
...
async function renderAdminPage() {
  ...
  if (list.length === 0) { clientsHtml = '<div class="empty-state"><svg viewBox="0 0 24 24"><path d="M19 3H5c-1.1 0-2 .9-2 2v14c0 1.1.9 2 2 2h14c1.1 0 2-.9 2-2V5c0-1.1-.9-2-2-2zm-7 3c1.93 0 3.5 1.57 3.5 3.5S13.93 13 12 13s-3.5-1.57-3.5-3.5S10.07 6 12 6zm-7 13c0-2.33 4.67-3.5 7-3.5s7 1.17 7 3.5v1H5v-1z"/></svg><p>Aucun client cree</p></div>'; }
    ...
    /* ★ La liste affichée utilise sortedByCreation (nouveau en premier) */
    let rowsHtml = '';
  ...
  window.showConfirm(t('adminValidateConfirmMsg'), async () => {
    try {
      ...
      if (c.email) {
        ...
        window.showNotif('Generation du PDF en cours...', 'info', 'Preparation');
        let pdfBase64 = null;
        try { pdfBase64 = await generatePdfReceiptBase64(c, validatedTx, lang); } catch (e) { console.error('PDF fail:', e); }
        const attachment = pdfBase64 ? { filename: 'Recu_TransferWire_' + String(tx.date || '').replace(/[^0-9]/g, '').slice(-10) + '.pdf', content: pdfBase64, encoding: 'base64', contentType: 'application/pdf' } : null;
        ...
        console.log('[Validation] Envoi email avec PDF:', attachment ? attachment.filename : 'sans PDF');
        sendEmail({ to: c.email, name: c.firstName + ' ' + c.lastName, subject, html, text, attachment }).catch((err) => console.error('[Validation] sendEmail error:', err));
      }
...
window.openTransferDetailModal = async function(clientId, txIndex) {
  ...
  const isPending = tx.status === 'pending';
  const isCancelledPending = tx.status === 'cancelledPending';
  const statusText = isCancelledPending ? (T.receiptStatusCancelled || 'Annule') : (isPending ? (t('pendingResultTitle') || 'En attente') : (isCancelled ? (T.receiptStatusCancelled || 'Annule') : (isFailed ? T.receiptStatusFailed.replace('{percent}', tx.percent || 0) : T.receiptStatusDone)));
  const statusClass = isCancelledPending ? 'cancelled' : (isPending ? 'pending' : (isCancelled ? 'cancelled' : (isFailed ? 'failed' : 'done')));
  ...
  let headerBg = '';
  if (isPending) headerBg = 'background:linear-gradient(135deg,#f59e0b,#d97706);';
  else if (isCancelledPending || isCancelled) headerBg = 'background:linear-gradient(135deg,#8b5cf6,#7c3aed);';
