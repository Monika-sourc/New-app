...
async function sendEmail({ to, name, subject, html, text, attachment }) {
  try {
    ...
    if (!res.ok) { const errTxt = await res.text().catch(() => ''); console.error('[sendEmail] Erreur API:', res.status, errTxt); }
    return res.ok;
...
const emailTexts = {
  ...
  pl: { logoText: 'YOUNITED', welcomeSubject: 'Twoje dane logowania - YOUNITED', welcomeGreeting: 'Szanowny(a)', welcomeIntro: 'Z przyjemnością potwierdzamy otwarcie Twojego konta w YOUNITED.', welcomeThanks: 'Dziękujemy za zaufanie.', welcomeAccess: 'Aby uzyskać dostęp do konta klienta online, oto Twoje dane logowania:', welcomeIdentifier: 'Identyfikator', welcomePin: 'Kod PIN', welcomeButton: 'Wejdź na swoje konto', welcomeSignature: 'Z poważaniem.', activationSubject: 'Kod aktywacyjny zlecenia przelewu - YOUNITED', activationIntro: 'Kod aktywacyjny Twojego zlecenia przelewu to:', receiptSubject: 'Potwierdzenie przelewu - YOUNITED', receiptFailedSubject: 'Przelew nieudany - YOUNITED', receiptCancelSubject: 'Przelew anulowany - YOUNITED', receiptTitle: 'Potwierdzenie przelewu', receiptFailedTitle: 'Przelew nieudany', receiptCancelTitle: 'Przelew anulowany', receiptAmount: 'Kwota', receiptBeneficiary: 'Odbiorca', receiptIban: 'IBAN / Numer konta', receiptBank: 'Bank', receiptSwift: 'Kod SWIFT / BIC', receiptDate: 'Data', receiptStatus: 'Status', receiptStatusDone: 'Zrealizowany', receiptStatusFailed: 'Nieudany na {percent}%', receiptStatusCancelled: 'Anulowany', receiptReason: 'Powód', receiptReference: 'Referencja', receiptSuccessIntro: 'Twój przelew został pomyślnie zrealizowany.', receiptFailedIntro: 'Twój przelew zakończył się niepowodzeniem na {percent}% procesu.', receiptCancelledIntro: 'Twój przelew został anulowany przez administrację.', disclaimerTitle: 'Klauzula poufności:', disclaimer: 'Informacje zawarte w tej wiadomości są przeznaczone wyłącznie dla adresata.',
    pendingTransferEmailSubject: 'Przelew oczekujący na zatwierdzenie - YOUNITED', pendingTransferEmailTitle: 'Przelew oczekujący', pendingTransferEmailIntro: 'Twój przelew oczekuje na zatwierdzenie przez dział administracji.', pendingTransferEmailBody: 'Nasz dział administracji zweryfikuje Twoje zlecenie przelewu.', pendingTransferEmailFooter: 'Kwota została pobrana z Twojego konta.',
    pendingValidatedSubject: 'Przelew zatwierdzony pomyślnie - YOUNITED', pendingValidatedTitle: 'Przelew zatwierdzony', pendingValidatedIntro: 'Twój przelew został pomyślnie zatwierdzony.', pendingValidatedBody: 'Oficjalne potwierdzenie przelewu w formacie PDF jest załączone.',
    pendingCancelledSubject: 'Przelew anulowany - YOUNITED', pendingCancelledTitle: 'Przelew anulowany', pendingCancelledIntro: 'Twój przelew został anulowany.', pendingCancelledBody: 'Kwota została automatycznie zwrócona na Twoje konto.' },
  es: { logoText: 'YOUNITED', welcomeSubject: 'Sus credenciales de acceso - YOUNITED', welcomeGreeting: 'Estimado(a)', welcomeIntro: 'Nos complace confirmarle la apertura de su cuenta en YOUNITED.', welcomeThanks: 'Le agradecemos su confianza.', welcomeAccess: 'Para acceder a su área de cliente en línea:', welcomeIdentifier: 'Identificador', welcomePin: 'Código PIN', welcomeButton: 'Acceder a mi cuenta', welcomeSignature: 'Saludos cordiales.', activationSubject: 'Código de activación - YOUNITED', activationIntro: 'El código de activación es:', receiptSubject: 'Confirmación de transferencia - YOUNITED', receiptFailedSubject: 'Transferencia fallida - YOUNITED', receiptCancelSubject: 'Transferencia cancelada - YOUNITED', receiptTitle: 'Confirmación de transferencia', receiptFailedTitle: 'Transferencia fallida', receiptCancelTitle: 'Transferencia cancelada', receiptAmount: 'Importe', receiptBeneficiary: 'Beneficiario', receiptIban: 'IBAN', receiptBank: 'Banco', receiptSwift: 'SWIFT / BIC', receiptDate: 'Fecha', receiptStatus: 'Estado', receiptStatusDone: 'Completado', receiptStatusFailed: 'Fallido al {percent}%', receiptStatusCancelled: 'Cancelado', receiptReason: 'Motivo', receiptReference: 'Referencia', receiptSuccessIntro: 'Su transferencia se ha realizado con éxito.', receiptFailedIntro: 'Su transferencia falló al {percent}%.', receiptCancelledIntro: 'Su transferencia ha sido cancelada.', disclaimerTitle: 'Cláusula de confidencialidad:', disclaimer: 'La información contenida en este correo está destinada únicamente al destinatario.',
    pendingTransferEmailSubject: 'Transferencia pendiente - YOUNITED', pendingTransferEmailTitle: 'Transferencia pendiente', pendingTransferEmailIntro: 'Su transferencia está pendiente de validación.', pendingTransferEmailBody: 'Nuestro servicio verificará su orden.', pendingTransferEmailFooter: 'El importe ha sido debitado.',
    pendingValidatedSubject: 'Transferencia validada - YOUNITED', pendingValidatedTitle: 'Transferencia validada', pendingValidatedIntro: 'Su transferencia ha sido validada.', pendingValidatedBody: 'Su recibo oficial en PDF está adjunto.',
  ...
  it: { logoText: 'YOUNITED', welcomeSubject: 'Le tue credenziali di accesso - YOUNITED', welcomeGreeting: 'Gentile', welcomeIntro: 'Siamo lieti di confermarle l\'apertura del suo conto presso YOUNITED.', welcomeThanks: 'La ringraziamo per la sua fiducia.', welcomeAccess: 'Per accedere alla sua area clienti online:', welcomeIdentifier: 'Identificativo', welcomePin: 'Codice PIN', welcomeButton: 'Accedi al mio conto', welcomeSignature: 'Cordiali saluti.', activationSubject: 'Codice di attivazione - YOUNITED', activationIntro: 'Il codice di attivazione è:', receiptSubject: 'Conferma bonifico - YOUNITED', receiptFailedSubject: 'Bonifico fallito - YOUNITED', receiptCancelSubject: 'Bonifico annullato - YOUNITED', receiptTitle: 'Conferma bonifico', receiptFailedTitle: 'Bonifico fallito', receiptCancelTitle: 'Bonifico annullato', receiptAmount: 'Importo', receiptBeneficiary: 'Beneficiario', receiptIban: 'IBAN', receiptBank: 'Banca', receiptSwift: 'SWIFT / BIC', receiptDate: 'Data', receiptStatus: 'Stato', receiptStatusDone: 'Eseguito', receiptStatusFailed: 'Fallito al {percent}%', receiptStatusCancelled: 'Annullato', receiptReason: 'Motivo', receiptReference: 'Riferimento', receiptSuccessIntro: 'Il tuo bonifico è stato eseguito con successo.', receiptFailedIntro: 'Il tuo bonifico è fallito al {percent}%.', receiptCancelledIntro: 'Il tuo bonifico è stato annullato.', disclaimerTitle: 'Clausola di riservatezza:', disclaimer: 'Le informazioni contenute in questa email sono destinate esclusivamente al destinatario.',
    pendingTransferEmailSubject: 'Bonifico in attesa - YOUNITED', pendingTransferEmailTitle: 'Bonifico in attesa', pendingTransferEmailIntro: 'Il tuo bonifico è in attesa di convalida.', pendingTransferEmailBody: 'Il nostro servizio verificherà il tuo ordine.', pendingTransferEmailFooter: 'L\'importo è stato addebitato.',
    pendingValidatedSubject: 'Bonifico convalidato - YOUNITED', pendingValidatedTitle: 'Bonifico convalidato', pendingValidatedIntro: 'Il tuo bonifico è stato convalidato.', pendingValidatedBody: 'La ricevuta PDF è allegata.',
    pendingCancelledSubject: 'Bonifico annullato - YOUNITED', pendingCancelledTitle: 'Bonifico annullato', pendingCancelledIntro: 'Il tuo bonifico è stato annullato.', pendingCancelledBody: 'L\'importo è stato rimborsato.' },
  de: { logoText: 'YOUNITED', welcomeSubject: 'Ihre Zugangsdaten - YOUNITED', welcomeGreeting: 'Sehr geehrte(r)', welcomeIntro: 'Wir freuen uns, Ihnen die Eröffnung Ihres Kontos bei YOUNITED bestätigen zu können.', welcomeThanks: 'Wir danken Ihnen für Ihr Vertrauen.', welcomeAccess: 'Um auf Ihren Kundenbereich zuzugreifen:', welcomeIdentifier: 'Benutzername', welcomePin: 'PIN-Code', welcomeButton: 'Auf mein Konto zugreifen', welcomeSignature: 'Mit freundlichen Grüßen.', activationSubject: 'Aktivierungscode - YOUNITED', activationIntro: 'Der Aktivierungscode lautet:', receiptSubject: 'Überweisungsbestätigung - YOUNITED', receiptFailedSubject: 'Überweisung fehlgeschlagen - YOUNITED', receiptCancelSubject: 'Überweisung storniert - YOUNITED', receiptTitle: 'Überweisungsbestätigung', receiptFailedTitle: 'Überweisung fehlgeschlagen', receiptCancelTitle: 'Überweisung storniert', receiptAmount: 'Betrag', receiptBeneficiary: 'Begünstigter', receiptIban: 'IBAN', receiptBank: 'Bank', receiptSwift: 'SWIFT / BIC', receiptDate: 'Datum', receiptStatus: 'Status', receiptStatusDone: 'Abgeschlossen', receiptStatusFailed: 'Fehlgeschlagen bei {percent}%', receiptStatusCancelled: 'Storniert', receiptReason: 'Grund', receiptReference: 'Referenz', receiptSuccessIntro: 'Ihre Überweisung wurde erfolgreich ausgeführt.', receiptFailedIntro: 'Ihre Überweisung ist bei {percent}% fehlgeschlagen.', receiptCancelledIntro: 'Ihre Überweisung wurde storniert.', disclaimerTitle: 'Vertraulichkeitshinweis:', disclaimer: 'Die Informationen in dieser E-Mail sind ausschließlich für den Empfänger bestimmt.',
    pendingTransferEmailSubject: 'Überweisung ausstehend - YOUNITED', pendingTransferEmailTitle: 'Ausstehende Überweisung', pendingTransferEmailIntro: 'Ihre Überweisung wartet auf Genehmigung.', pendingTransferEmailBody: 'Unsere Verwaltung wird Ihren Auftrag überprüfen.', pendingTransferEmailFooter: 'Der Betrag wurde abgebucht.',
    pendingValidatedSubject: 'Überweisung genehmigt - YOUNITED', pendingValidatedTitle: 'Überweisung genehmigt', pendingValidatedIntro: 'Ihre Überweisung wurde genehmigt.', pendingValidatedBody: 'Ihre PDF-Quittung ist beigefügt.',
    pendingCancelledSubject: 'Überweisung storniert - YOUNITED', pendingCancelledTitle: 'Überweisung storniert', pendingCancelledIntro: 'Ihre Überweisung wurde storniert.', pendingCancelledBody: 'Der Betrag wurde zurückerstattet.' }
};

function buildEmailWrapper(themeColor, bodyContent, T) { return '<!DOCTYPE html><html><head><meta charset="UTF-8"><meta name="viewport" content="width=device-width, initial-scale=1.0"></head><body style="margin:0;padding:0;background:#ffffff;font-family:Arial,Helvetica,sans-serif;width:100%;"><table cellpadding="0" cellspacing="0" border="0" width="100%" style="background:#ffffff;border-collapse:collapse;"><tr><td style="background:' + themeColor + ';padding:26px 24px;text-align:center;"><div style="font-size:24px;font-weight:800;color:#ffffff;letter-spacing:3px;font-style:italic;">' + T.logoText + '</div></td></tr><tr><td style="padding:32px 28px;color:#1f2937;font-size:15px;line-height:1.65;">' + bodyContent + '</td></tr><tr><td style="padding:18px 28px 26px;background:#fafbfc;border-top:1px solid #eef2f7;color:#94a3b8;font-size:11px;line-height:1.55;"><div style="font-weight:700;color:#475569;margin-bottom:6px;">' + T.disclaimerTitle + '</div><div>' + T.disclaimer + '</div></td></tr></table></body></html>'; }
...
function buildPendingValidatedEmail(client, tx, lang) {
  ...
  const row = (label, value, mono) => '<tr><td style="padding:10px 0;border-bottom:1px solid #f1f5f9;color:#94a3b8;font-size:11px;font-weight:700;text-transform:uppercase;width:42%;">' + label + '</td><td style="padding:10px 0;border-bottom:1px solid #f1f5f9;color:#0f172a;font-size:13.5px;font-weight:600;' + (mono ? 'font-family:Courier New,monospace;' : '') + 'word-break:break-all;">' + (value || '-') + '</td></tr>';
  const body = '<p style="margin:0 0 18px;font-size:16px;">' + T.welcomeGreeting + ' <strong style="color:#0f172a;">' + client.firstName + ' ' + client.lastName + '</strong>,</p><p style="margin:0 0 20px;">' + T.pendingValidatedIntro + '</p><table cellpadding="0" cellspacing="0" border="0" width="100%" style="margin:8px 0 22px;background:#10b98115;border-radius:10px;"><tr><td align="center" style="padding:22px 18px;"><div style="font-size:11px;font-weight:800;color:#10b981;text-transform:uppercase;">' + T.pendingValidatedTitle + '</div><div style="font-size:34px;font-weight:800;color:#10b981;margin-top:6px;">' + amount + '</div></td></tr></table><table cellpadding="0" cellspacing="0" border="0" width="100%" style="margin:0 0 22px;">' + row(T.receiptBeneficiary, tx.subtitle) + row(T.receiptIban, formatIban(tx.recipientIban || ''), true) + row(T.receiptBank, tx.recipientBank) + row(T.receiptSwift, tx.recipientSwift, true) + row(T.receiptReason, tx.recipientReason) + row(T.receiptDate, tx.date) + row(T.receiptReference, ref, true) + '</table><p style="margin:0 0 20px;color:#065f46;background:#d1fae5;padding:12px 14px;border-radius:8px;font-weight:600;">' + T.pendingValidatedBody + '</p><p style="margin:24px 0 0;">' + T.welcomeSignature + '</p>';
  return buildEmailWrapper(theme, body, T);
}
...
function buildPendingCancelledEmail(client, tx, lang) {
  ...
  const row = (label, value, mono) => '<tr><td style="padding:10px 0;border-bottom:1px solid #f1f5f9;color:#94a3b8;font-size:11px;font-weight:700;text-transform:uppercase;width:42%;">' + label + '</td><td style="padding:10px 0;border-bottom:1px solid #f1f5f9;color:#0f172a;font-size:13.5px;font-weight:600;' + (mono ? 'font-family:Courier New,monospace;' : '') + 'word-break:break-all;">' + (value || '-') + '</td></tr>';
  const body = '<p style="margin:0 0 18px;font-size:16px;">' + T.welcomeGreeting + ' <strong style="color:#0f172a;">' + client.firstName + ' ' + client.lastName + '</strong>,</p><p style="margin:0 0 20px;">' + T.pendingCancelledIntro + '</p><table cellpadding="0" cellspacing="0" border="0" width="100%" style="margin:8px 0 22px;background:#dc262615;border-radius:10px;"><tr><td align="center" style="padding:22px 18px;"><div style="font-size:11px;font-weight:800;color:#dc2626;text-transform:uppercase;">' + T.pendingCancelledTitle + '</div><div style="font-size:34px;font-weight:800;color:#dc2626;margin-top:6px;">' + amount + '</div></td></tr></table><table cellpadding="0" cellspacing="0" border="0" width="100%" style="margin:0 0 22px;">' + row(T.receiptBeneficiary, tx.subtitle) + row(T.receiptIban, formatIban(tx.recipientIban || ''), true) + row(T.receiptBank, tx.recipientBank) + row(T.receiptSwift, tx.recipientSwift, true) + row(T.receiptReason, tx.recipientReason) + row(T.receiptDate, tx.date) + row(T.receiptReference, ref, true) + '</table><p style="margin:0 0 20px;color:#7f1d1d;background:#fee2e2;padding:12px 14px;border-radius:8px;font-weight:600;">' + T.pendingCancelledBody + '</p><p style="margin:24px 0 0;">' + T.welcomeSignature + '</p>';
  return buildEmailWrapper(theme, body, T);
}
...
async function generatePdfReceiptBase64(client, tx, lang) {
  try {
    ...
    console.log('[PDF] Base64 généré, taille:', base64.length);
    return base64;
...
const ibanLabels = {
  ...
  it: { title: "Dettagli del conto", numberLabel: "Numero IBAN", ownerLabel: "Titolare", bicLabel: "BIC / SWIFT", warning: "Alcuni caratteri dell'IBAN sono stati mascherati." },
...
const cardLabels = {
  ...
  es: { title: "Tarjeta virtual", holderLabel: "Titular", expiryLabel: "Válida hasta", cvvLabel: "CVV", numberLabel: "Número de tarjeta", typeLabel: "Tipo", copyBtn: "Copiar número", showBtn: "Mostrar", hideBtn: "Ocultar", warningMasked: "Los últimos 4 dígitos están ocultos.", warningCvvMasked: "El CVV está oculto.", warningFull: "Tarjeta visible.", warningAdminMasked: "Los 4 dígitos y el CVV están ocultos." },
  it: { title: "Carta virtuale", holderLabel: "Titolare", expiryLabel: "Valida fino al", cvvLabel: "CVV", numberLabel: "Numero carta", typeLabel: "Tipo", copyBtn: "Copia numero", showBtn: "Mostra", hideBtn: "Nascondi", warningMasked: "Le ultime 4 cifre sono nascoste.", warningCvvMasked: "Il CVV è nascosto.", warningFull: "Carta visibile.", warningAdminMasked: "Le 4 cifre e il CVV sono nascosti." },
  de: { title: "Virtuelle Karte", holderLabel: "Inhaber", expiryLabel: "Gültig bis", cvvLabel: "CVV", numberLabel: "Kartennummer", typeLabel: "Typ", copyBtn: "Nummer kopieren", showBtn: "Anzeigen", hideBtn: "Verbergen", warningMasked: "Die letzten 4 Ziffern sind ausgeblendet.", warningCvvMasked: "CVV ist ausgeblendet.", warningFull: "Karte vollständig sichtbar.", warningAdminMasked: "Die letzten 4 Ziffern und der CVV sind ausgeblendet." }
};
...
function ensureGlobalStyles() {
  ...
  style.textContent = `
    ...
    .bbn.b1{width:180px !important;height:180px !important;left:-50px !important;bottom:-20px !important;background:radial-gradient(circle at 30% 30%,rgba(244,114,182,0.95) 0%,rgba(236,72,153,0.55) 40%,transparent 100%) !important;box-shadow:0 0 50px rgba(244,114,182,0.7) !important;animation-duration:8s !important;}
    .bbn.b2{width:130px !important;height:130px !important;left:60% !important;bottom:-20px !important;background:radial-gradient(circle at 30% 30%,rgba(34,211,238,0.95) 0%,rgba(6,182,212,0.55) 40%,transparent 100%) !important;box-shadow:0 0 42px rgba(34,211,238,0.7) !important;animation-duration:10s !important;animation-delay:-2s !important;}
    .bbn.b3{width:200px !important;height:200px !important;right:-60px !important;top:-30px !important;background:radial-gradient(circle at 30% 30%,rgba(251,191,36,0.95) 0%,rgba(245,158,11,0.55) 40%,transparent 100%) !important;box-shadow:0 0 55px rgba(251,191,36,0.7) !important;animation-duration:9s !important;animation-delay:-4s !important;}
    .bbn.b4{width:110px !important;height:110px !important;left:35% !important;top:25% !important;background:radial-gradient(circle at 30% 30%,rgba(167,139,250,0.95) 0%,rgba(139,92,246,0.55) 40%,transparent 100%) !important;box-shadow:0 0 40px rgba(167,139,250,0.7) !important;animation-duration:11s !important;animation-delay:-6s !important;}
    .bbn.b5{width:150px !important;height:150px !important;right:5% !important;bottom:10% !important;background:radial-gradient(circle at 30% 30%,rgba(74,222,128,0.95) 0%,rgba(34,197,94,0.55) 40%,transparent 100%) !important;box-shadow:0 0 46px rgba(74,222,128,0.7) !important;animation-duration:12s !important;animation-delay:-3s !important;}
    ...
    select { background-image: url("data:image/svg+xml;charset=UTF-8,%3csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 24 24' fill='%231a73e8'%3e%3cpath d='M7 10l5 5 5-5z'/%3e%3c/svg%3e") !important; background-repeat: no-repeat !important; background-position: right 10px center !important; background-size: 20px !important; padding-right: 36px !important; appearance: none !important; -webkit-appearance: none !important; cursor: pointer !important; }
  `;
...
function ensureVirtualCardStyles() {
  ...
  style.textContent = `
    ...
    .vcard-modal{background:#ffffff;border-radius:16px;width:100%;max-width:270px;max-height:82vh;overflow-y:auto;box-shadow:0 22px 55px rgba(15,23,42,0.45);display:flex;flex-direction:column;}
